...
public class CLayout extends JFrame {
    ...
    private static final Color MARRONE = new Color(149,84,54,255);
    private static final Color AZZURRO = new Color (170,224,250,255);
    private static final Color ROSA = new Color (217,58,150,255);
    private static final Color ARANCIONE = new Color (246,147,28,255);
    private static final Color ROSSO = new Color (246,147,28,255);
    private static final Color GIALLO = new Color (251,243,3,255);
    private static final Color VERDE = new Color (31,178,90,255);
    private static final Color BLU = new Color (0,114,187,255);
    private static final Color CREMISI = new Color (192,43,77,255);
